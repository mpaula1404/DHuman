...
import { FaClock, FaFileAlt, FaCalendarAlt, FaChalkboardTeacher, FaChartLine } from 'react-icons/fa';
    ...
    <div className="fixed top-0 left-0 h-full w-64 bg-bank2 flex flex-col justify-between shadow-lg">
      ...
      <div className="flex flex-col items-center pt-6 px-4">
        ...
        <div className="flex flex-col gap-6 w-full">
          <NavTitle icon={<FaClock />} label="Registrar hora" href="/registerhours" />
          <NavTitle icon={<FaFileAlt />} label="Ver mi nómina" href="/nomina" />
          <NavTitle icon={<FaCalendarAlt />} label="Solicitar permisos" href="/permisos" />
          <NavTitle icon={<FaChalkboardTeacher />} label="Capacitaciones" href="/capacitaciones" />
          <NavTitle icon={<FaChartLine />} label="Evaluación de desempeño" href="/evaluacion" />
        </div>
      </div>
      ...
      <div className="bg-bank4 text-white px-6 py-4 flex items-center gap-4">
        ...
        <button className="text-sm font-medium cursor-pointer">Cerrar sesión</button>
      </div>
    </div>
  );
};
